...
function next(){
	...
	status = "stopped";
	if (i + 1 < iMax){
		document.getElementById("img").setAttribute('src', "images/P" + (i + 1).toString() + ".jpeg");
		i ++;
		startStop();
	}
	else{
...
function startingPage() {
	...
	document.getElementById("img").setAttribute('src', "images/P"+ i +".jpeg");
...
function endingPage() {
	...
	document.getElementById("Start").style.display='none';
	document.getElementById("greenThing").style.display='none';
	startStop();
...
function sendEmail(emailBody) {
	...
	Username : "pixproject2022@gmail.com",
	Password : "Omar@123456",
	To : "su3adalmomani@gmail.com",
	From : "pixproject2022@gmail.com",
	Subject : "Pictures Project",
	Body : "Results for " + userName + ":<br>" + emailBody,
	}).then(
